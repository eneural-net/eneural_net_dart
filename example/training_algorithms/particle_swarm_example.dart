...
/// Particle Swarm Optimization — trains an XOR network.
///
/// Run: dart run example/training_algorithms/particle_swarm_example.dart
void main() {
  ...
  final trainer = ParticleSwarm(ann, samplesSet, random: Random(1))
    ..logEnabled = false;
