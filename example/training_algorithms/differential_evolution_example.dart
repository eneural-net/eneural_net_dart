...
/// Differential Evolution — trains an XOR network.
///
/// Run: dart run example/training_algorithms/differential_evolution_example.dart
void main() {
  ...
  final trainer = DifferentialEvolution(ann, samplesSet, random: Random(1))
    ..logEnabled = false;
