...
/// Nadam (Nesterov Adam) — trains an XOR network.
///
/// Run: dart run example/training_algorithms/nadam_example.dart
void main() {
  ...
  final trainer = Adam(ann, samplesSet, learningRate: 0.05, nesterov: true)
    ..logEnabled = false
