...
/// SGD with momentum — trains an XOR network.
///
/// Run: dart run example/training_algorithms/sgd_example.dart
void main() {
  ...
  final trainer = SGD(ann, samplesSet, learningRate: 0.5, momentum: 0.9)
    ..logEnabled = false
