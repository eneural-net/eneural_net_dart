...
/// AdamW (decoupled weight decay) — trains an XOR network.
///
/// Run: dart run example/training_algorithms/adamw_example.dart
void main() {
  ...
  final trainer = Adam(ann, samplesSet, learningRate: 0.05, weightDecay: 0.001)
    ..logEnabled = false
