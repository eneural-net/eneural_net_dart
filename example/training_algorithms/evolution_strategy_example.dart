...
/// Evolution Strategy — trains an XOR network.
///
/// Run: dart run example/training_algorithms/evolution_strategy_example.dart
void main() {
  ...
  final trainer = EvolutionStrategy(ann, samplesSet, random: Random(1))
    ..logEnabled = false;
