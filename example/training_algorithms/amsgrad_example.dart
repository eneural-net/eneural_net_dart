...
/// AMSGrad — trains an XOR network.
///
/// Run: dart run example/training_algorithms/amsgrad_example.dart
void main() {
  ...
  final trainer = Adam(ann, samplesSet, learningRate: 0.05, amsgrad: true)
    ..logEnabled = false
