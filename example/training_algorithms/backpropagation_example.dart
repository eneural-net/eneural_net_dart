...
/// Backpropagation — trains an XOR network.
///
/// Run: dart run example/training_algorithms/backpropagation_example.dart
void main() {
  ...
  final trainer = Backpropagation(ann, samplesSet)
    ..logEnabled = false
