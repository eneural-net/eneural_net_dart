...
/// Separable CMA-ES — trains an XOR network.
///
/// Run: dart run example/training_algorithms/separable_cmaes_example.dart
void main() {
  ...
  final trainer = SeparableCMAES(ann, samplesSet, random: Random(1))
    ..logEnabled = false;
