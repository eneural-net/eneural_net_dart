...
/// Simulated Annealing — trains an XOR network.
///
/// Run: dart run example/training_algorithms/simulated_annealing_example.dart
void main() {
  ...
  final trainer = SimulatedAnnealing(ann, samplesSet, random: Random(1))
    ..logEnabled = false;
