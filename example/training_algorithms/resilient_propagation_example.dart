...
/// ResilientPropagation (RProp family) — trains an XOR network.
///
/// Run: dart run example/training_algorithms/resilient_propagation_example.dart
void main() {
  ...
  final trainer =
      ResilientPropagation(ann, samplesSet, variant: RPropVariant.iRpropPlus)
        ..logEnabled = false
  ...
  print(
    'ResilientPropagation (RProp family): '
